...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-CfpNF9XF.mjs";
require_react();
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DBRwiGw7.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BJTWA7IJ.mjs"),
		import("./start-CVH61Pv1.mjs"),

...
export const products: Product[] = [
  {
    ...
    description:
      "شاشة Super Retina XDR مقاس 6.7 بوصة، تصميم تيتانيوم قوي وخفيف، كاميرا رئيسية 48 ميجابكسل، منفذ USB-C.",
    price: 820000,
    oldPrice: 940000,
    stock: 34,
  ...
  },
  {
    ...
    description:
      "تنظيف ذكي بالكامل، تتبع الخريطة بالليزر LiDAR، شفط فائق القوة للأتربة والسجاد، مسح رطب وجاف.",
    price: 245000,
    oldPrice: 280000,
    stock: 12,
  ...
  },
  {
    ...
    description:
      "خلاط عصائر لاسلكي قابل للشحن عبر USB، شفرات حادة، تصميم رياضي مناسب للجيم والرحلات.",
    price: 14500,
    oldPrice: 19000,
    stock: 45,
  ...
  },
  {
    ...
    description:
      "هيكل متين مقاوم للصدأ، غطاء قماشي واقٍ من الغبار، تتسع لما يصل إلى 27 زوجاً من الأحذية.",
    price: 11200,
    stock: 18,
  ...
  },
  {
    ...
    description:
      "6 مستويات سرعة، 4 رؤوس تدليك مخصصة لراحة العضلات العميقة وتخفيف التوتر بعد التمرين.",
    price: 21000,
    oldPrice: 27000,
    stock: 27,
  ...
  },
  {
    ...
    description:
      "أفضل عزل للضوضاء في العالم، صوت استثنائي عالي الدقة، ميكروفونات متطورة للمكالمات الواضحة.",
    price: 260000,
    oldPrice: 320000,
    stock: 60,
  ...
  },
  {
    ...
    description:
      "مفك لاسلكي قابل للشحن مع مجموعة واسعة من الرؤوس المغناطيسية، كشاف LED مدمج لأعمال الصيانة الدقيقة.",
    price: 18500,
    stock: 9,

...
export function discountPercentForCoupon(couponCode?: string | null): number {
  ...
  return STOREFRONT_COUPON_DISCOUNTS[normalized as keyof typeof STOREFRONT_COUPON_DISCOUNTS] ?? 0;
}

export function discountAmountForCoupon(subtotal: number, couponCode?: string | null): number {

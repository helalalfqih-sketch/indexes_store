...
function ReturnPolicyPage() {
  return (
    <TrustPage
      ...
      description="الشروط الأساسية لطلب الإرجاع أو الاستبدال."
    >
      <section>
      ...
      <section>
        <h2>حالة المنتج</h2>
        <p>
          يجب أن يكون المنتج بحالته الأصلية، غير مستخدم، وفي عبوته الأصلية. تواصل معنا قبل إعادة
          المنتج لتأكيد الخطوات.
        </p>
      </section>
    </TrustPage>
  );

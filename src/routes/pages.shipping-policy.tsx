...
function ShippingPolicyPage() {
  return (
    <TrustPage title="سياسة الشحن والتوصيل" description="معلومات الشحن والتوصيل للطلبات داخل اليمن.">
      <section>
        <h2>مدة التوصيل</h2>
      ...
      <section>
        <h2>تأكيد الطلب</h2>
        <p>تبدأ مدة التوصيل بعد تأكيد الطلب وبيانات العنوان ورقم الهاتف. قد تتغير المدة حسب المحافظة وتوفر المنتج.</p>
      </section>
    </TrustPage>
  );
}

...
export const Route = createFileRoute("/immersive-store")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "تجربة تسوق سباتيال فاخرة — استكشف المنتجات ثلاثية الأبعاد بحرية." },
    ],
  }),
    ...
    >
      ...
      <div className="absolute inset-0">
        <img
          ...
          draggable={false}
        />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_10%,rgba(31,94,255,0.35),transparent_55%),radial-gradient(circle_at_85%_90%,rgba(102,166,255,0.28),transparent_55%),radial-gradient(circle_at_50%_50%,transparent_40%,rgba(0,0,0,0.85)_100%)]" />
        ...
        <motion.div
          ...
          style={{
            background:
              "conic-gradient(from 180deg at 50% 50%, rgba(31,94,255,0.12), rgba(102,166,255,0.08), rgba(168,85,247,0.1), rgba(31,94,255,0.12))",
      ...
      <div className="pointer-events-none absolute inset-x-0 top-0 z-40 flex items-center justify-between gap-3 px-3 pt-4 sm:px-8">
        ...
        <div className="pointer-events-auto hidden items-center gap-2 rounded-full border border-white/15 bg-black/30 px-4 py-2 text-[11px] font-bold text-white/90 backdrop-blur-xl sm:flex">
          <span className="grid h-2 w-2 place-items-center rounded-full bg-[#66A6FF] shadow-[0_0_10px_#66A6FF]" />
          المعرض السباتيال — اندكس ستور
        </div>

        <div className="pointer-events-auto flex items-center gap-1.5 rounded-full border border-white/20 bg-white/10 px-3.5 py-2 text-[11px] font-bold text-white backdrop-blur-xl sm:text-xs">
          <Sparkles className="h-3.5 w-3.5 text-[#66A6FF]" />
          Vision · 3D
        </div>
      </div>
      ...
      <div className="pointer-events-none absolute inset-x-0 top-20 z-30 text-center">
        ...
        >
          استكشف منتجاتك <span className="text-[#66A6FF]">بحرية</span>
        </motion.h1>
        <p className="mx-auto mt-1 max-w-xs text-[11px] text-white/60 sm:max-w-md sm:text-sm">
              ...
              >
                <motion.div
                  ...
                  style={
                    {
                      background:
                        "radial-gradient(circle at 30% 25%, rgba(255,255,255,0.35), rgba(31,94,255,0.15) 55%, rgba(4,6,13,0.6) 100%)",
                      boxShadow:
                        "0 20px 60px -18px rgba(31,94,255,0.55), 0 0 0 1px rgba(255,255,255,0.08) inset, 0 0 30px -6px rgba(102,166,255,0.35)",
                ...
                <span className="mt-2 line-clamp-1 max-w-[70px] text-center text-[10px] font-bold text-white/80 sm:max-w-[110px] sm:text-xs">
                  {p.name}
                </span>
                <span className="mt-0.5 text-[10px] font-black text-[#66A6FF] sm:text-xs">
                  {formatPrice(p.price)}
                </span>
              </button>
            );
      ...
      <div className="pointer-events-none absolute inset-x-0 bottom-0 z-40 flex items-center justify-between gap-3 px-3 pb-5 sm:px-8">
        <div className="rounded-full border border-white/15 bg-black/40 px-3.5 py-2 text-[10px] text-white/70 backdrop-blur-xl sm:text-[11px]">
          ...
          <>
            ...
            <div className="pointer-events-none fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-8">
              <motion.div
                ...
                style={{
                  background:
                    "linear-gradient(140deg, rgba(31,94,255,0.22), rgba(10,14,28,0.75))",
              ...
              >
                ...
                <div className="grid gap-3 p-3 sm:grid-cols-2 sm:gap-6 sm:p-6">
                  ...
                  <motion.div
                    ...
                    style={{
                      background:
                        "radial-gradient(circle at 30% 25%, rgba(102,166,255,0.35), rgba(15,20,40,0.7) 60%, rgba(4,6,13,0.9) 100%)",
                      boxShadow:
                        "inset 0 0 60px rgba(31,94,255,0.25), 0 0 0 1px rgba(255,255,255,0.06) inset",
                    }}
                  >
                    <ModelStage src={modelFor(product.id)} poster={product.image} />
                    <div className="pointer-events-none absolute start-3 top-3 flex items-center gap-1.5 rounded-full border border-white/20 bg-black/40 px-2.5 py-1 text-[10px] font-bold text-white/90 backdrop-blur-md">
                  ...
                  <div className="flex flex-col justify-between gap-4 p-1 sm:p-2">
                    <div>
                      <div className="flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-widest text-[#66A6FF]">
                      ...
                      <div className="mt-4 grid grid-cols-3 gap-2 text-center">
                        {[
                          ...
                          >
                            <div className="text-[9px] text-white/60 sm:text-[10px]">{s.k}</div>
                            <div className="text-xs font-black text-white sm:text-sm">{s.v}</div>
                          </div>
                        ))}
                      </div>
                    </div>

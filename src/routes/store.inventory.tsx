        ...
        {invQ.isLoading ? (
          ...
          <div className="max-h-96 space-y-1.5 overflow-y-auto">
            {inv!.movements.map((m) => (
              ...
              >
                <span
                  className={`rounded-full px-2 py-0.5 font-black ${m.delta > 0 ? "bg-success/10 text-success" : "bg-destructive/10 text-destructive"}`}
                >

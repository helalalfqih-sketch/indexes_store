    ...
    <div className="max-w-4xl mx-auto py-12 px-4 space-y-8" dir="rtl">
      ...
      <div className="space-y-6 text-sm text-foreground leading-relaxed">
        <div className="rounded-2xl border border-border bg-surface p-6 space-y-3">
          ...
          <p>
            باستخدامك لمنصة ومتجر Indexes Store، فإنك توافق على الالتزام بكافة الشروط والأحكام
            الواردة هنا، والامتثال لسياسات التجارة الإلكترونية المعمول بها.
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-border bg-surface p-6 space-y-3">
          ...
          <p>
            يتم تجهيز كافة الطلبات وتوصيلها وفقاً لبيانات العنوان المرفقة من قبل العميل، وتتم عمليات
            الدفع والتسليم وفق الشفافية التامة المعتمدة في متجرنا.
          </p>
        </div>
      </div>
    </div>
